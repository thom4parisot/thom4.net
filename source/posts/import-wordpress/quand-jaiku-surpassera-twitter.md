...
[Cela fait maintenant plus d'1 an que j'utilise Twitter](/2007/twitter-gtwitter/). Passée l'appréhension du gadget puéril, je l'ai finalement converti en **outil de communication**, de **réseautage** et de **veille** ... comme beaucoup de ses utilisateurs d'ailleurs.
...
*   **automatisation de l'intégration de vos flux** (RSS, Twitter, Last.fm etc.) avec une présentation des plus sympathiques (exemple ci-dessus avec [Flickr, mon service photo préféré](/2008/flickr-le-site-ideal-pour-partager-ses-photos/))
...
Après, ma seule crainte ce sont les [habituels travers de Google, abandon de service, manque de suivi et opacité de service](/2008/google-ange-demon-vie-numerique/).

Je garde bon espoir pour Jaiku. À tel point que je suis même en train de produire un [widget Netvibes](/code/netvibes/ "widget Netvibes pour Jaiku") pour _Jaikuter_ depuis n'importe où ;-)
