...
Cela faisait un petit moment que je n'avais pas réalisé de [widget Netvibes](/code/netvibes/). À vrai dire, je n'en avais pas publié depuis 2008\. C'était encore le boom et la folie des widgets.

Le compteur est remis à zéro cette année avec la publication du [widget VCUB](/code/netvibes/vcub/).
...
Quelques jours après, le [widget VCUB](/code/netvibes/) était né. Vous pouvez [ajouter le widget VCUB sur votre page Netvibes en 2 clics](http://eco.netvibes.com/subscribe/378209).
