...
Pour information, j'ai également publié un billet expliquant [comment migrer un flux RSS vers Feedburner](/2007/migrer-un-flux-rss-vers-feedburner/) pour celles et ceux ne pouvant installer ce plugin.
