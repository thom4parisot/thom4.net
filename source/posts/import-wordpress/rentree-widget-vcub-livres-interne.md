...
Un peu forcée puisque l'on s'est quitté lors du [lancement des RMLL 2010](/2010/rmll-2010/), au début du mois de juillet. Je n'ai pas pris le temps d'en dresser un compte-rendu. Toujours est-il que ce fût une expérience à vivre, tant lors des conférences que des _afters_.
...
J'ai peaufiné le [widget VCUB pour Netvibes annoncé en avril dernier](/2010/widget-netvibes-vcub/). J'ai ajouté ces quelques éléments :
